...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        $error = "Mots de Passe où Mail invalide";
    }
}
?>
<!DOCTYPE html>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Entrez votre email et votre mots de passe afin de vous connectez</p>
                  </div>
                  <?php if (!empty($error)): ?>
                  ...
                  <form method="POST" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Merci de mettre une adresse mail.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Merci de mettre un mots de passe</div>
                    </div>
